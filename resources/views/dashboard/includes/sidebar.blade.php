            ...
            <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                <li class="nav-item start active open">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="icon-home"></i>
                        <span class="title">Dashboard11</span>
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item  ">
                            <a href="{{route('profile.create')}}" class="nav-link ">
                                <i class="icon-plus"></i>
                                <span class="title">اضافه موظف</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                            <a href="{{route('profile.index')}}" class="nav-link ">
                                <i class="icon-magnifier"></i>
                                <span class="title">جميع الموظفين</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item  ">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        ...
                        <span class="title">البراندات</span>
                        <span class="arrow"></span>
                    </a>
                    <ul class="sub-menu">
                        <li class="nav-item  ">
                            <a href="{{route('brand.create')}}" class="nav-link ">
                                <i class="icon-plus"></i>
                                <span class="title">اضافه براند</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                            <a href="{{route('brand.index')}}" class="nav-link ">
                                <i class="icon-magnifier"></i>
                                <span class="title">جميع البراندات</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-plane"></i> تاجات المنتج
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item  ">
                                    <a href="{{route('tags.create')}}" class="nav-link ">
                                        <i class="icon-plus"></i>
                                        <span class="title">اضافه تاج</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item  ">
                                    <a href="{{route('tags.index')}}" class="nav-link nav-toggle">
                                        <i class="icon-magnifier"></i>
                                        <span class="title">جميع التاجات</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                <li class="nav-item">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class="icon-settings"></i>
                        <span class="title">{{trans('dashboard\sidebar.settings')}}</span>
                        <span class="arrow "></span>
                    </a>
                    <ul class="sub-menu">
                        <li class="nav-item">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-plane"></i> {{trans('dashboard\sidebar.shippingMethods')}}
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">

                                <li class="nav-item">
                                    <a href="{{route('settings.editShippingMethods','free')}}" class="nav-link">
                                        <i class="icon-pointer"></i> {{trans('dashboard\sidebar.freeShipping')}}</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('settings.editShippingMethods','inner')}}" class="nav-link">
                                        <i class="icon-pointer"></i> {{trans('dashboard\sidebar.innerShipping')}}</a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('settings.editShippingMethods','outer')}}" class="nav-link">
                                        <i class="icon-pointer"></i> {{trans('dashboard\sidebar.outerShipping')}}</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
