                    ...
                    <div class="portlet light bordered">
                        <div class="col-md-12 ">
                            <div class="dt-buttons but">
                                ...
                                <a href="{{route('profile.create')}}" class="dt-button buttons-pdf buttons-html5 btn red btn-outline" tabindex="0" aria-controls="sample_1"> <i class="fa fa-plus fa "></i><span> اضافه موظف</span></a>
                                <a  href="{{route('profile.pdf')}}" target="_blank" class="dt-button buttons-pdf buttons-html5 btn purple  btn-outline" tabindex="0" aria-controls="sample_1"><span>تصدير pdf</span></a>
                                <a  href="{{route('profile.CSV')}}" class="dt-button buttons-csv buttons-html5 btn green btn-outline" tabindex="0" aria-controls="sample_1"><span>تصدير CSV</span></a>
                            </div>
                        </div>
    ...
    <script >
        $(document).ready(function() {
            ...
            $("body").on( 'click', '.status', function () {
                ...
                $.ajax({
                    url: "{{url("admin/profile/updateStatus/{id}")}}",
                    type:"PUT",
                    dataType:"json",
                    data: allData,
                    beforeSend:function(){
