                    ...
                    <div class="portlet light bordered">
                        <div class="col-md-12 ">
                            <div class="dt-buttons but">
                                ...
                                <a href="{{route('tags.create')}}" class="dt-button buttons-pdf buttons-html5 btn red btn-outline" tabindex="0" aria-controls="sample_1"> <i class="fa fa-plus fa "></i><span> اضافه تاج</span></a>
                                <a  href="{{route('tags.pdf')}}" target="_blank" class="dt-button buttons-pdf buttons-html5 btn purple  btn-outline" tabindex="0" aria-controls="sample_1"><span>تصدير pdf</span></a>
                                <a  href="{{route('tags.CSV')}}" class="dt-button buttons-csv buttons-html5 btn green btn-outline" tabindex="0" aria-controls="sample_1"><span>تصدير CSV</span></a>
                            </div>
                        </div>
        ...
        $(document).ready(function() {
            ...
            $("body").on( 'click', '.img-edit', function () {
                ...
                $("#updateImage").submit(function(){
                    ...
                    $.ajax({
                        url: "{{url("admin/tags/update_image/{id}")}}",
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        type: "POST",
            ...
            $("body").on( 'click', '.status', function () {
                ...
                $.ajax({
                    url: "{{url("admin/tags/updateStatus/{id}")}}",
                    type:"PUT",
                    dataType:"json",
                    data: allData,
                    beforeSend:function(){
