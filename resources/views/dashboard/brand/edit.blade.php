                                ...
                                <div class="row">
                                    <div class="col-md-6  ">
                                        <div class="form-group ">
                                            ...
                                            <input type="text"  value="{{$brand ->translate('ar')-> name }}" name="name_ar" class="form-control" placeholder="">
                                            @error("name_ar")
                                        ...
                                        <div class="form-group form-md-radios">
                                            ...
                                            <div class="md-radio-inline">
                                                ...
                                                <div class="md-radio">
                                                    <input type="radio" id="radio7" value="1"  {{ ($brand->status == 1) ? "checked" : " " }} name="status" class="md-radiobtn" checked="">
                                                    <label for="radio7">
                                                        <span></span>
                                                ...
                                                <div class="md-radio">
                                                    <input type="radio" id="radio8"  value="2"  {{ ($brand->status == 2) ? "checked" : " " }} name="status" class="md-radiobtn">
                                                    <label for="radio8">
                                                        <span></span>
                                                        <span class="check"></span>
                                    ...
                                    <div class="col-md-6 en"  >
                                        <div class="form-group ">
                                            ...
                                            <input   type="text"  value="{{$brand ->translate('en')-> name }}" name="name_en" class="form-control" placeholder="">
                                            @error("name_en")
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
