                                    ...
                                    <div class="col-md-6  ">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                ...
                                                <textarea name="description_ar" id="adr_description" class="form-control" rows="3">{{old('description_ar')}}</textarea>
                                            </div>
                                            {{--                                            <script>--}}
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="texte" name="url"  value="{{old('url')}}"  class="form-control" placeholder="">
                                            @error("url")
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group form-md-radios ">
                                            ...
                                            <div class="md-radio-inline">
                                                ...
                                                <div class="md-radio">
                                                    <input type="radio" id="radio71"  value="1"   name="sub" class="md-radiobtn sub" >
                                                    <label for="radio71">
                                                        <span></span>
                                                ...
                                                <div class="md-radio">
                                                    <input type="radio" id="radio81"  value="2"   name="sub" class="md-radiobtn sub" checked >
                                                    <label for="radio81">
                                                        <span></span>
                                                        <span class="check"></span>
